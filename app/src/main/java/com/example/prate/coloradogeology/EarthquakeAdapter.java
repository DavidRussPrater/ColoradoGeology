...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        } else if (originalLocation.equals(STATE_ONLY)) {
            // If the epicenter is unknown change dont use "near the"
            locationOffset = getContext().getString(R.string.epicenter_unknown);
            primaryLocation = getContext().getString(R.string.greater_colorado_area);
    ...
    private int getMagnitudeColor(double magnitude){
        ...
        switch (magnitudeFloor) {
            case 0:
            case 1:
                magnitudeColorResourceId = R.color.magnitude_1;
                break;
            case 2:
                magnitudeColorResourceId = R.color.magnitude_2;
                break;
            case 3:
                magnitudeColorResourceId = R.color.magnitude_3;
                break;
            case 4:
                magnitudeColorResourceId = R.color.magnitude_4;
                break;
            case 5:
                magnitudeColorResourceId = R.color.magnitude_5;
                break;
            case 6:
                magnitudeColorResourceId = R.color.magnitude_6;
                break;
            case 7:
                magnitudeColorResourceId = R.color.magnitude_7;
                break;
            case 8:
                magnitudeColorResourceId = R.color.magnitude_8;
                break;
            case 9:
                magnitudeColorResourceId = R.color.magnitude_9;
                break;
            default:
